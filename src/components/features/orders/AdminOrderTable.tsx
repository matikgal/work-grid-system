          ...
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
              ...
              {shops.map((n) => (
                <th
                  key={n}
                  className="p-4 min-w-[80px] text-xs font-bold uppercase text-center text-slate-600 dark:text-slate-400 border-r border-slate-200 dark:border-slate-800 last:border-0 opacity-50"
                >
                  Sklep {n}
                </th>
              ))}
                ...
                >
                  <td className="p-0 border-r border-slate-200 dark:border-slate-800">
                    <input
                      ...
                      className="w-full h-full p-4 bg-transparent focus:outline-none focus:bg-blue-50 dark:focus:bg-blue-900/20 font-bold text-slate-800 dark:text-white placeholder:text-slate-300 dark:placeholder:text-slate-600 placeholder:font-normal"
                  ...
                  {shops.map((n) => {
                    ...
                    return (
                      <td
                        key={n}
                        className="p-4 text-center border-r border-slate-200 dark:border-slate-800 text-slate-400 text-sm"
                      >
                        {shopResp?.value || "-"}
                      </td>
                    );
