...
export const SHIFT_TEMPLATES: ShiftTemplate[] = [
  { id: 't1', label: '6-14', startTime: '06:00', endTime: '14:00', colorClass: 'bg-emerald-100 border-emerald-300 text-emerald-800', type: 'work' },
  { id: 't3', label: '14-22', startTime: '14:00', endTime: '22:00', colorClass: 'bg-indigo-100 border-indigo-300 text-indigo-800', type: 'work' },
